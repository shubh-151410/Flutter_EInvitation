...
class SaveBackGround extends StatefulWidget {
  String localfile;
  String networkfile;
  Color color;
  var creatCardData;
  ...
  SaveBackGround(
      ...
      this.userType});
  @override
  _SaveBackGroundState createState() => _SaveBackGroundState();
}

class _SaveBackGroundState extends State<SaveBackGround> {
  double _height = 0.0;
  double _width = 0.0;
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ViewImage(
              ...
              categoryId: (widget.creatCardData != null)
                  ? widget.creatCardData.categoryId
                  : widget.categoryId,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int index) async {
          ...
          if (index == 2) {
            ...
            await apiremote.getQrCode((widget.creatCardData != null)
                ? widget.creatCardData.categoryId
                : widget.categoryId);
                      ...
                      children: [
                        (widget.networkfile != null)
                            ...
                            : (widget.localfile != null)
                                ? Container(
                                    child: Image.file(File(widget.localfile)),
                                  )
                                : (widget.color != null)
                                    ? Container(
                                        height: 400,
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          ...
                                          color: Color(int.tryParse(
                                              "0xff${_editorState.listTextStyle[i]['color']}")),
                  ...
                  ? TextFieldDialog(
                      addEvent: (date) {
                        if (editText != null) {
                          ...
                          _editorState.textCard.removeAt(selectedIndex);
                          _editorState.listTextStyle.removeAt(selectedIndex);
                          _editorState.textCard.insert(selectedIndex, date);
                          _editorState.listTextStyle
                              .insert(selectedIndex, currentStyle);
          ...
          children: listColor.map((e) {
            return InkWell(
              ...
              child: Container(
                height: 50,
                width: 30,
                color: Color(int.tryParse('0xff$e')),
              ),
            );
          }).toList(),
        )
