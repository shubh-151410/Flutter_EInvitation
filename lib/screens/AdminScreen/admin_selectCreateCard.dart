...
class AdminSelectCreateCard extends StatefulWidget {
  int categoryid;
  String userType;
  AdminSelectCreateCard({this.categoryid,this.userType});
  @override
  _AdminSelectCreateCardState createState() => _AdminSelectCreateCardState();
}

class _AdminSelectCreateCardState extends State<AdminSelectCreateCard> {
  double _height = 0.0;
  double _width = 0.0;
  var cameras;
